...
const {getAllProduct, addProduct, updateProduct, deleteProduct, findProduct , uploadProductImage , productImage , deleteProductImage} = require("../../controllers/bussinessOwnerControllers/onlineMenu")
